...
$(document).ready(function(){
  ...
  HEIGHT = window.innerHeight;
	$('#contenedor-fuego').width(WIDTH).height("540px");
	canvas = document.getElementById('pixie');
	$(canvas).attr('width', WIDTH).attr('height','540px');
...
function Circle() {
	this.s = {ttl:8000, xmax:15, ymax:12, rmax:15, rt:1, xdef:960, ydef:540, xdrift:4, ydrift: 4, random:true, blink:true};
	...
	this.draw = function() {
		...
		g.addColorStop(0.0, 'rgba(255,144,24,'+newo+')');
...
window.onload = function() {
    ...
    $(".loader").remove();
    $('.animacion').addClass('efecto-crecer');
};
